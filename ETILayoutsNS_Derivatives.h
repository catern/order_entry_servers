...
#define	TID_APPROVE_REVERSE_TES_TRADE_REQUEST            10631		// < ApproveReverseTESTradeRequest (Approve Reverse TES Trade Request)
...
#define	TID_PING_REQUEST                                 10320		// < PingRequest (Ping Request)
#define	TID_PING_RESPONSE                                10321		// < PingResponse (Ping Response)
...
#define	TID_REVERSE_TES_TRADE_REQUEST                    10630		// < ReverseTESTradeRequest (Reverse TES Trade Request)
...
#define	TID_SRQS_INQUIRE_SMART_RESPONDENT_REQUEST        10718		// < SRQSInquireSmartRespondentRequest (SRQS Inquire Smart Respondent Request)
#define	TID_SRQS_INQUIRE_SMART_RESPONDENT_RESPONSE       10719		// < SRQSInquireSmartRespondentResponse (SRQS Inquire Smart Respondent Response)
...
#define	TID_TES_COMPRESSION_RUN_STATUS_BROADCAST         10618		// < TESCompressionRunStatusBroadcast (TES Compression Run Status Broadcast )
#define	TID_TES_COMPRESSION_RUN_STATUS_REQUEST           10616		// < TESCompressionRunStatusRequest (TES Compression Run Status Request)
#define	TID_TES_COMPRESSION_RUN_STATUS_RESPONSE          10617		// < TESCompressionRunStatusResponse (TES Compression Run Status Response)
...
#define	TID_TES_REVERSAL_BROADCAST                       10632		// < TESReversalBroadcast (TES Reversal Broadcast)
...
const int ETI_DERIVATIVES_TID_MAX = 10719;  // highest assigned template ID
...
#define MAX_AMEND_BASKET_TRADE_REQUEST_INSTRMT_MATCH_SIDE_GRP	199
#define MAX_AMEND_BASKET_TRADE_REQUEST_BASKET_SIDE_ALLOC_GRP	398
#define MAX_APPROVE_BASKET_TRADE_REQUEST_BASKET_SIDE_ALLOC_EXT_GRP	398
#define MAX_BASKET_APPROVE_BROADCAST_BASKET_ROOT_PARTY_GRP	2
#define MAX_BASKET_APPROVE_BROADCAST_BASKET_SIDE_ALLOC_EXT_BC_GRP	398
#define MAX_BASKET_BROADCAST_BASKET_ROOT_PARTY_GRP      	3
#define MAX_BASKET_BROADCAST_INSTRMT_MATCH_SIDE_GRP     	199
#define MAX_BASKET_BROADCAST_BASKET_SIDE_ALLOC_GRP      	398
#define MAX_BASKET_EXECUTION_BROADCAST_BASKET_EXEC_GRP  	199
...
#define MAX_ENTER_BASKET_TRADE_REQUEST_INSTRMT_MATCH_SIDE_GRP	199
#define MAX_ENTER_BASKET_TRADE_REQUEST_BASKET_SIDE_ALLOC_GRP	398
#define MAX_ENTER_CLIP_REQUEST_CROSS_REQUEST_SIDE_GRP   	2
#define MAX_ENTER_CLIP_REQUEST_SIDE_CROSS_LEG_GRP       	40
#define MAX_ENTER_TES_TRADE_REQUEST_SIDE_ALLOC_GRP      	99
...
#define MAX_MODIFY_BASKET_TRADE_REQUEST_INSTRMT_MATCH_SIDE_GRP	199
#define MAX_MODIFY_BASKET_TRADE_REQUEST_BASKET_SIDE_ALLOC_GRP	398
...
#define MAX_SRQS_CREATE_DEAL_NOTIFICATION_SRQS_TARGET_PARTY_TRD_GRP	30
#define MAX_SRQS_DEAL_NOTIFICATION_SRQS_TARGET_PARTY_TRD_GRP	30
#define MAX_SRQS_DEAL_RESPONSE_SRQS_QUOTE_GRP           	30
#define MAX_SRQS_HIT_QUOTE_REQUEST_SRQS_HIT_QUOTE_GRP   	30
#define MAX_SRQS_INQUIRE_SMART_RESPONDENT_RESPONSE_SMART_PARTY_DETAIL_GRP	1000
...
#define MAX_TES_REVERSAL_BROADCAST_SIDE_ALLOC_GRPBC     	99
#define MAX_TES_TRADE_BROADCAST_SRQS_RELATED_TRADE_ID_GRP	12
#define MAX_TES_UPLOAD_BROADCAST_SIDE_ALLOC_EXT_GRP     	99
...
#define MAX_UPLOAD_TES_TRADE_REQUEST_SIDE_ALLOC_EXT_GRP 	99
...
// DataType BasketPartyContraFirm
#define LEN_BASKET_PARTY_CONTRA_FIRM                     5
...
#define ENUM_BASKET_TRADE_REPORT_TYPE_NO_VALUE           ((uint8_t) 0xff)

// DataType BidPxIsLocked
#define ENUM_BID_PX_IS_LOCKED_NO                         0
#define ENUM_BID_PX_IS_LOCKED_YES                        1
#define ENUM_BID_PX_IS_LOCKED_NO_VALUE                   ((uint8_t) 0xff)

// DataType ComplianceText
#define LEN_COMPLIANCE_TEXT                              20

// DataType CompressionAction
...
#define ENUM_COMPRESSION_ACTION_NO_VALUE                 ((uint8_t) 0xff)

// DataType CompressionStatus
...
#define ENUM_COMPRESSION_STATUS_NO_VALUE                 ((uint8_t) 0xff)
...
#define ENUM_DEFAULT_CSTM_APPL_VER_SUBID_NO_VALUE        0
...
#define ENUM_DELETE_REASON_NO_VALUE                      ((uint8_t) 0xff)

// DataType EffectOnBasket
#define ENUM_EFFECT_ON_BASKET_ADD_VOLUME                 1
#define ENUM_EFFECT_ON_BASKET_REMOVE_VOLUME              2
#define ENUM_EFFECT_ON_BASKET_NO_VALUE                   ((uint8_t) 0xff)

// DataType EnlightRFQAvgRespRateRanking
...
#define ENUM_ENLIGHT_RFQ_AVG_RESP_RATE_RANKING_NO_VALUE  ((uint8_t) 0xff)

// DataType EnlightRFQAvgRespTimeRanking
...
#define ENUM_EXECUTING_TRADER_QUALIFIER_NO_VALUE         ((uint8_t) 0xff)
...
#define ENUM_FREE_TEXT5_DISCLOSURE_INSTRUCTION_NO_VALUE  ((uint8_t) 0xff)
...
#define ENUM_GATEWAY_STATUS_NO_VALUE                     ((uint8_t) 0xff)
...
#define ENUM_HEDGE_TYPE_NO_VALUE                         ((uint8_t) 0xff)

// DataType HedgingInstruction
#define ENUM_HEDGING_INSTRUCTION_ON_CLOSE                1
#define ENUM_HEDGING_INSTRUCTION_NO_VALUE                ((uint8_t) 0xff)
...
#define ENUM_INSTR_ATTRIB_TYPE_NO_VALUE                  ((uint8_t) 0xff)
...
#define ENUM_LAST_MKT_NO_VALUE                           ((uint16_t) 0xffff)
...
#define ENUM_LAST_PX_DISCLOSURE_INSTRUCTION_NO_VALUE     ((uint8_t) 0xff)
...
#define ENUM_LAST_QTY_DISCLOSURE_INSTRUCTION_NO_VALUE    ((uint8_t) 0xff)
...
#define ENUM_LEAVES_QTY_DISCLOSURE_INSTRUCTION_NO_VALUE  ((uint8_t) 0xff)
...
#define ENUM_LEG_INPUT_SOURCE_NO_VALUE                   ((uint8_t) 0xff)
...
#define ENUM_MESSAGE_EVENT_SOURCE_NO_VALUE               0
...
#define ENUM_MSG_TYPE_PARTY_DETAILS_LIST_REQUEST         "CF "
#define ENUM_MSG_TYPE_PARTY_DETAILS_LIST_REPORT          "CG "
...
#define ENUM_NUMBER_OF_RESP_DISCLOSURE_INSTRUCTION_NO_VALUE ((uint8_t) 0xff)

// DataType OfferPxIsLocked
#define ENUM_OFFER_PX_IS_LOCKED_NO                       0
#define ENUM_OFFER_PX_IS_LOCKED_YES                      1
#define ENUM_OFFER_PX_IS_LOCKED_NO_VALUE                 ((uint8_t) 0xff)
...
#define ENUM_ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_NO_VALUE ((uint8_t) 0xff)
...
#define ENUM_ORDER_ATTRIBUTE_RISK_REDUCTION_NO_VALUE     ((uint8_t) 0xff)
...
#define ENUM_ORDER_ORIGINATION_NO_VALUE                  ((uint8_t) 0xff)
...
#define ENUM_ORDER_QTY_DISCLOSURE_INSTRUCTION_NO_VALUE   ((uint8_t) 0xff)

// DataType OrderQtyIsLocked
#define ENUM_ORDER_QTY_IS_LOCKED_NO                      0
#define ENUM_ORDER_QTY_IS_LOCKED_YES                     1
#define ENUM_ORDER_QTY_IS_LOCKED_NO_VALUE                ((uint8_t) 0xff)
...
#define ENUM_OWNERSHIP_INDICATOR_NO_VALUE                ((uint8_t) 0xff)
...
#define ENUM_PARTY_ACTION_TYPE_NO_VALUE                  ((uint8_t) 0xff)
...
#define ENUM_PARTY_DETAIL_ROLE_QUALIFIER_NO_VALUE        ((uint8_t) 0xff)
...
// DataType PartyDetailStatusInformation
#define ENUM_PARTY_DETAIL_STATUS_INFORMATION_TRR_THR_ESH_OLD_TOO_BIG 1
#define ENUM_PARTY_DETAIL_STATUS_INFORMATION_BLOCK_ALL_ANO_NYM_OUS 2
#define ENUM_PARTY_DETAIL_STATUS_INFORMATION_NO_VALUE    ((uint8_t) 0xff)
...
#define ENUM_PARTY_ID_ORIGINATION_MARKET_NO_VALUE        ((uint8_t) 0xff)
...
#define ENUM_PARTY_ID_SETTLEMENT_LOCATION_NO_VALUE       ((uint8_t) 0xff)
...
#define ENUM_PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE ((uint8_t) 0xff)

// DataType PartyOrderOriginationDisclosureInstruction
...
#define ENUM_PARTY_ORDER_ORIGINATION_DISCLOSURE_INSTRUCTION_NO_VALUE ((uint8_t) 0xff)

// DataType PartyOrderOriginationTrader
#define LEN_PARTY_ORDER_ORIGINATION_TRADER               132

// DataType PartySubIDType
#define ENUM_PARTY_SUB_ID_TYPE_BUYER                     14001
#define ENUM_PARTY_SUB_ID_TYPE_SELLER                    14002
#define ENUM_PARTY_SUB_ID_TYPE_NO_VALUE                  ((uint16_t) 0xffff)
...
#define ENUM_PRICE_DISCLOSURE_INSTRUCTION_NO_VALUE       ((uint8_t) 0xff)
...
// DataType QuoteCancelReason
#define ENUM_QUOTE_CANCEL_REASON_EXPIRED                 5
#define ENUM_QUOTE_CANCEL_REASON_NO_VALUE                ((uint8_t) 0xff)

// DataType QuoteCancelType
#define ENUM_QUOTE_CANCEL_TYPE_CANCEL_ALL_QUOTES         4
#define ENUM_QUOTE_CANCEL_TYPE_NO_VALUE                  ((uint8_t) 0xff)

// DataType QuoteCondition
#define LEN_QUOTE_CONDITION                              1
#define ENUM_QUOTE_CONDITION_ACTIVE                      "A"
#define ENUM_QUOTE_CONDITION_ACTIVE_CHAR                 'A'
#define ENUM_QUOTE_CONDITION_CLOSED                      "B"
#define ENUM_QUOTE_CONDITION_CLOSED_CHAR                 'B'
#define ENUM_QUOTE_CONDITION_SUSPENDED                   "z"
#define ENUM_QUOTE_CONDITION_SUSPENDED_CHAR              'z'
#define ENUM_QUOTE_CONDITION_EXPIRED                     "8"
#define ENUM_QUOTE_CONDITION_EXPIRED_CHAR                '8'
#define ENUM_QUOTE_CONDITION_NO_VALUE                    0
...
#define ENUM_QUOTE_ENTRY_REJECT_REASON_TOO_MANY_ORDERS_AND_QUOTES_IN_ORDER_BOOK 163
#define ENUM_QUOTE_ENTRY_REJECT_REASON_CONTRACT_CANNOT_BE_TRADED_DUE_TO_INSUFFICIENT_ELIGIBILITY 166
#define ENUM_QUOTE_ENTRY_REJECT_REASON_NO_VALUE          ((uint32_t) 0xffffffff)
...
#define ENUM_QUOTE_ENTRY_STATUS_NO_VALUE                 ((uint8_t) 0xff)
...
#define ENUM_QUOTE_EVENT_LIQUIDITY_IND_NO_VALUE          ((uint8_t) 0xff)
...
#define ENUM_QUOTE_EVENT_REASON_NO_VALUE                 ((uint8_t) 0xff)

// DataType QuoteEventSide
#define ENUM_QUOTE_EVENT_SIDE_BUY                        1
#define ENUM_QUOTE_EVENT_SIDE_SELL                       2
#define ENUM_QUOTE_EVENT_SIDE_NO_VALUE                   ((uint8_t) 0xff)
...
#define ENUM_QUOTE_INSTRUCTION_NO_VALUE                  ((uint8_t) 0xff)
...
#define ENUM_QUOTE_SIZE_TYPE_NO_VALUE                    ((uint8_t) 0xff)
...
#define ENUM_QUOTE_STATUS_NO_VALUE                       ((uint8_t) 0xff)
...
#define ENUM_QUOTING_STATUS_NO_VALUE                     ((uint8_t) 0xff)
...
#define ENUM_REQUESTING_PARTY_ID_ENTERING_FIRM_NO_VALUE  ((uint8_t) 0xff)
...
#define ENUM_REQUESTING_PARTY_ID_EXECUTING_SYSTEM_NO_VALUE ((uint32_t) 0xffffffff)
...
#define ENUM_REQUESTING_PARTY_SUB_ID_TYPE_NO_VALUE       ((uint16_t) 0xffff)

// DataType RespondentType
#define ENUM_RESPONDENT_TYPE_ALL_MARKET_PARTICIPANTS     1
#define ENUM_RESPONDENT_TYPE_ANONYMOUS                   102
#define ENUM_RESPONDENT_TYPE_NO_VALUE                    ((uint8_t) 0xff)

// DataType ReversalCancellationReason
...
#define ENUM_REVERSAL_CANCELLATION_REASON_NO_VALUE       ((uint8_t) 0xff)

// DataType ReversalIndicator
#define ENUM_REVERSAL_INDICATOR_NO                       0
#define ENUM_REVERSAL_INDICATOR_YES                      1
#define ENUM_REVERSAL_INDICATOR_NO_VALUE                 ((uint8_t) 0xff)

// DataType ReversalReasonText
#define LEN_REVERSAL_REASON_TEXT                         132
...
#define ENUM_RISK_LIMIT_ACTION_NO_VALUE                  ((uint8_t) 0xff)
...
#define ENUM_RISK_LIMIT_REQUESTING_PARTY_ROLE_NO_VALUE   ((uint8_t) 0xff)
...
#define ENUM_RISK_LIMIT_VIOLATION_INDICATOR_NO_VALUE     ((uint8_t) 0xff)
...
#define ENUM_ROOT_PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE ((uint8_t) 0xff)
...
#define ENUM_ROOT_PARTY_SUB_ID_TYPE_NO_VALUE             ((uint16_t) 0xffff)
...
#define ENUM_SECONDARY_GATEWAY_STATUS_NO_VALUE           ((uint8_t) 0xff)
...
#define ENUM_SELECTIVE_REQUEST_FOR_QUOTE_SERVICE_STATUS_NO_VALUE ((uint8_t) 0xff)
...
#define ENUM_SESSION_SUB_MODE_NO_VALUE                   ((uint8_t) 0xff)
...
#define ENUM_SETTL_METHOD_NO_VALUE                       0

// DataType ShowLastDealOnClosure
#define ENUM_SHOW_LAST_DEAL_ON_CLOSURE_NO                0
#define ENUM_SHOW_LAST_DEAL_ON_CLOSURE_YES               1
#define ENUM_SHOW_LAST_DEAL_ON_CLOSURE_NO_VALUE          ((uint8_t) 0xff)
...
#define ENUM_SIDE_DISCLOSURE_INSTRUCTION_NO_VALUE        ((uint8_t) 0xff)

// DataType SideIsLocked
#define ENUM_SIDE_IS_LOCKED_NO                           0
#define ENUM_SIDE_IS_LOCKED_YES                          1
#define ENUM_SIDE_IS_LOCKED_NO_VALUE                     ((uint8_t) 0xff)
...
#define ENUM_SIDE_LIQUIDITY_IND_NO_VALUE                 ((uint8_t) 0xff)

// DataType SideTrdSubTyp
#define ENUM_SIDE_TRD_SUB_TYP_BLOCK_TRADE                2001
#define ENUM_SIDE_TRD_SUB_TYP_TRADE_AT_MARKET            2004
#define ENUM_SIDE_TRD_SUB_TYP_NO_VALUE                   ((uint16_t) 0xffff)

// DataType SkipValidations
#define ENUM_SKIP_VALIDATIONS_FALSE                      0
#define ENUM_SKIP_VALIDATIONS_TRUE                       1
#define ENUM_SKIP_VALIDATIONS_NO_VALUE                   ((uint8_t) 0xff)

// DataType SwapClearer
#define ENUM_SWAP_CLEARER_ECAG                           0
#define ENUM_SWAP_CLEARER_NON_ECAG                       1
#define ENUM_SWAP_CLEARER_NO_VALUE                       ((uint8_t) 0xff)
...
#define ENUM_T7_ENTRY_SERVICE_RTM_STATUS_NO_VALUE        ((uint8_t) 0xff)
...
#define ENUM_T7_ENTRY_SERVICE_STATUS_NO_VALUE            ((uint8_t) 0xff)
...
// DataType TradeAggregationTransType
#define ENUM_TRADE_AGGREGATION_TRANS_TYPE_NEW            0
#define ENUM_TRADE_AGGREGATION_TRANS_TYPE_NO_VALUE       ((uint8_t) 0xff)
...
#define ENUM_TRADE_ALLOC_STATUS_NO_VALUE                 ((uint8_t) 0xff)
...
#define ENUM_TRADE_PLATFORM_NO_VALUE                     ((uint8_t) 0xff)
...
#define ENUM_TRADE_PUBLISH_INDICATOR_NO_VALUE            ((uint8_t) 0xff)
...
#define ENUM_TRADE_REQUEST_RESULT_NO_VALUE               ((uint8_t) 0xff)

// DataType TradeToQuoteRatioRanking
...
#define ENUM_TRADE_TO_QUOTE_RATIO_RANKING_NO_VALUE       ((uint8_t) 0xff)
...
#define ENUM_TRANSACTION_DELAY_INDICATOR_NO_VALUE        ((uint8_t) 0xff)

// DataType TransferReason
#define ENUM_TRANSFER_REASON_OWNER                       1
#define ENUM_TRANSFER_REASON_CLEARER                     2
#define ENUM_TRANSFER_REASON_NO_VALUE                    ((uint8_t) 0xff)
...
#define ENUM_TRD_RPT_STATUS_NO_VALUE                     ((uint8_t) 0xff)
...
#define ENUM_TRD_TYPE_BLOCK_QTPIP                        1007
...
#define ENUM_UNDERLYING_STIP_TYPE_NO_VALUE               0
...
#define ENUM_USER_STATUS_NO_VALUE                        ((uint8_t) 0xff)
...
#define ENUM_VALUE_CHECK_TYPE_MIN_LOT_SIZE_NO_VALUE      ((uint8_t) 0xff)
...
// TemplateID:  10631
// Alias:       Approve Reverse TES Trade Request
...
// FIX MsgType: PartyDetailsListRequest = "CF"
typedef struct
{
    MessageHeaderInCompT MessageHeaderIn;
    RequestHeaderCompT RequestHeader;
...
// FIX MsgType: PartyDetailsListReport = "CG"
typedef struct
{
    MessageHeaderOutCompT MessageHeaderOut;
    ResponseHeaderCompT ResponseHeader;
...
// TemplateID:  10630
// Alias:       Reverse TES Trade Request
// FIX MsgType: TradeCaptureReport = "AE"
typedef struct
{
    MessageHeaderInCompT MessageHeaderIn;
    ...
    uint16_t TrdType;
    char TradeReportID[LEN_TRADE_REPORTID];
    char ReversalReasonText[LEN_REVERSAL_REASON_TEXT];
    char Pad6[LEN_PAD6];
...
typedef struct
{
    ...
    SRQSTargetPartyTrdGrpSeqT SRQSTargetPartyTrdGrp[MAX_SRQS_CREATE_DEAL_NOTIFICATION_SRQS_TARGET_PARTY_TRD_GRP];
...
typedef struct
{
    ...
    char PartyIDTakeUpTradingFirm[LEN_PARTY_ID_TAKE_UP_TRADING_FIRM];
    char Pad1[LEN_PAD1];
    SRQSTargetPartyTrdGrpSeqT SRQSTargetPartyTrdGrp[MAX_SRQS_DEAL_NOTIFICATION_SRQS_TARGET_PARTY_TRD_GRP];
...
typedef struct
{
    ...
    char FirmNegotiationID[LEN_FIRM_NEGOTIATIONID];
    char Pad3[LEN_PAD3];
    SRQSQuoteGrpSeqT SRQSQuoteGrp[MAX_SRQS_DEAL_RESPONSE_SRQS_QUOTE_GRP];
} SRQSDealResponseT;
...
typedef struct
{
    ...
    char PartyIDTakeUpTradingFirm[LEN_PARTY_ID_TAKE_UP_TRADING_FIRM];
    char Pad2[LEN_PAD2];
    SRQSHitQuoteGrpSeqT SRQSHitQuoteGrp[MAX_SRQS_HIT_QUOTE_REQUEST_SRQS_HIT_QUOTE_GRP];
} SRQSHitQuoteRequestT;

// Message:	    SRQSInquireSmartRespondentRequest
// TemplateID:  10718
// Alias:       SRQS Inquire Smart Respondent Request
// FIX MsgType: PartyDetailsListRequest = "CF"
typedef struct
{
    MessageHeaderInCompT MessageHeaderIn;
...
// TemplateID:  10719
// Alias:       SRQS Inquire Smart Respondent Response
// FIX MsgType: PartyDetailsListReport = "CG"
typedef struct
{
    MessageHeaderOutCompT MessageHeaderOut;
    ...
    uint16_t NoPartyDetails;
    char Pad2[LEN_PAD2];
    SmartPartyDetailGrpSeqT SmartPartyDetailGrp[MAX_SRQS_INQUIRE_SMART_RESPONDENT_RESPONSE_SMART_PARTY_DETAIL_GRP];
...
typedef struct
{
    ...
    char QuoteCondition[LEN_QUOTE_CONDITION];
    char PartyExecutingFirm[LEN_PARTY_EXECUTING_FIRM];
    char PartyExecutingTrader[LEN_PARTY_EXECUTING_TRADER];
    char PartyEnteringTrader[LEN_PARTY_ENTERING_TRADER];
    char TargetPartyExecutingFirm[LEN_TARGET_PARTY_EXECUTING_FIRM];
    ...
    char FirmNegotiationID[LEN_FIRM_NEGOTIATIONID];
    char FreeText5[LEN_FREE_TEXT5];
    char PartyOrderOriginationTrader[LEN_PARTY_ORDER_ORIGINATION_TRADER];
...
// Message:	    TESCompressionRunStatusBroadcast
// TemplateID:  10618
// Alias:       TES Compression Run Status Broadcast
// FIX MsgType: TradeCaptureReport = "AE"
typedef struct
{
    MessageHeaderOutCompT MessageHeaderOut;
...
// Message:	    TESCompressionRunStatusRequest
// TemplateID:  10616
// Alias:       TES Compression Run Status Request
// FIX MsgType: TradeCaptureReport = "AE"
typedef struct
{
    MessageHeaderInCompT MessageHeaderIn;
...
// Message:	    TESCompressionRunStatusResponse
// TemplateID:  10617
// Alias:       TES Compression Run Status Response
...
typedef struct
{
    ...
    char ReversalReasonText[LEN_REVERSAL_REASON_TEXT];
    char Pad3[LEN_PAD3];
    SideAllocGrpBCSeqT SideAllocGrpBC[MAX_TES_REVERSAL_BROADCAST_SIDE_ALLOC_GRPBC];
...
typedef struct
{
    ...
    char BasketPartyContraFirm[LEN_BASKET_PARTY_CONTRA_FIRM];
    char BasketSideTradeReportID[LEN_BASKET_SIDE_TRADE_REPORTID];
    char Pad4[LEN_PAD4];
...
#define	TID_APPROVEREVERSETESTRADEREQUEST                10631		// < ApproveReverseTESTradeRequest (Approve Reverse TES Trade Request)
...
#define	TID_PINGREQUEST                                  10320		// < PingRequest (Ping Request)
#define	TID_PINGRESPONSE                                 10321		// < PingResponse (Ping Response)
...
#define	TID_REVERSETESTRADEREQUEST                       10630		// < ReverseTESTradeRequest (Reverse TES Trade Request)
...
#define	TID_SRQSINQUIRESMARTRESPONDENTREQUEST            10718		// < SRQSInquireSmartRespondentRequest (SRQS Inquire Smart Respondent Request)
#define	TID_SRQSINQUIRESMARTRESPONDENTRESPONSE           10719		// < SRQSInquireSmartRespondentResponse (SRQS Inquire Smart Respondent Response)
...
#define	TID_TESCOMPRESSIONRUNSTATUSBROADCAST             10618		// < TESCompressionRunStatusBroadcast (TES Compression Run Status Broadcast )
#define	TID_TESCOMPRESSIONRUNSTATUSREQUEST               10616		// < TESCompressionRunStatusRequest (TES Compression Run Status Request)
#define	TID_TESCOMPRESSIONRUNSTATUSRESPONSE              10617		// < TESCompressionRunStatusResponse (TES Compression Run Status Response)
...
#define	TID_TESREVERSALBROADCAST                         10632		// < TESReversalBroadcast (TES Reversal Broadcast)
...
#define MAX_AMENDBASKETTRADEREQUEST_INSTRMTMATCHSIDEGRP 	199
#define MAX_AMENDBASKETTRADEREQUEST_BASKETSIDEALLOCGRP  	398
#define MAX_APPROVEBASKETTRADEREQUEST_BASKETSIDEALLOCEXTGRP	398
#define MAX_BASKETAPPROVEBROADCAST_BASKETROOTPARTYGRP   	2
#define MAX_BASKETAPPROVEBROADCAST_BASKETSIDEALLOCEXTBCGRP	398
#define MAX_BASKETBROADCAST_BASKETROOTPARTYGRP          	3
#define MAX_BASKETBROADCAST_INSTRMTMATCHSIDEGRP         	199
#define MAX_BASKETBROADCAST_BASKETSIDEALLOCGRP          	398
#define MAX_BASKETEXECUTIONBROADCAST_BASKETEXECGRP      	199
...
#define MAX_ENTERBASKETTRADEREQUEST_INSTRMTMATCHSIDEGRP 	199
#define MAX_ENTERBASKETTRADEREQUEST_BASKETSIDEALLOCGRP  	398
#define MAX_ENTERCLIPREQUEST_CROSSREQUESTSIDEGRP        	2
#define MAX_ENTERCLIPREQUEST_SIDECROSSLEGGRP            	40
#define MAX_ENTERTESTRADEREQUEST_SIDEALLOCGRP           	99
...
#define MAX_MODIFYBASKETTRADEREQUEST_INSTRMTMATCHSIDEGRP	199
#define MAX_MODIFYBASKETTRADEREQUEST_BASKETSIDEALLOCGRP 	398
...
#define MAX_SRQSCREATEDEALNOTIFICATION_SRQSTARGETPARTYTRDGRP	30
#define MAX_SRQSDEALNOTIFICATION_SRQSTARGETPARTYTRDGRP  	30
#define MAX_SRQSDEALRESPONSE_SRQSQUOTEGRP               	30
#define MAX_SRQSHITQUOTEREQUEST_SRQSHITQUOTEGRP         	30
#define MAX_SRQSINQUIRESMARTRESPONDENTRESPONSE_SMARTPARTYDETAILGRP	1000
...
#define MAX_TESREVERSALBROADCAST_SIDEALLOCGRPBC         	99
#define MAX_TESTRADEBROADCAST_SRQSRELATEDTRADEIDGRP     	12
#define MAX_TESUPLOADBROADCAST_SIDEALLOCEXTGRP          	99
...
#define MAX_UPLOADTESTRADEREQUEST_SIDEALLOCEXTGRP       	99
...
#define LEN_BASKETPARTYCONTRAFIRM                        5
...
#define ENUM_BIDPXISLOCKED_NO                            0
#define ENUM_BIDPXISLOCKED_YES                           1
#define LEN_COMPLIANCETEXT                               20
#define ENUM_COMPRESSIONACTION_START_COMPRESSION         1
#define ENUM_COMPRESSIONACTION_COMMIT_COMPRESSION        2
#define ENUM_COMPRESSIONACTION_CANCEL_COMPRESSION        3
#define ENUM_COMPRESSIONSTATUS_OPEN                      1
#define ENUM_COMPRESSIONSTATUS_EXECUTED                  2
#define ENUM_COMPRESSIONSTATUS_CANCELLED_BY_USER         3
#define ENUM_COMPRESSIONSTATUS_CANCELLED_BY_SYSTEM       4
...
#define ENUM_DELETEREASON_AMENDMENT_RESET                108
#define ENUM_DELETEREASON_AMENDMENT_USER_CANCELLED       109
#define ENUM_DELETEREASON_COMPRESSION_CANCELLED_BY_USER  110
#define ENUM_DELETEREASON_COMPRESSION_CANCELLED_BY_SYSTEM 111
#define ENUM_EFFECTONBASKET_ADD_VOLUME                   1
#define ENUM_EFFECTONBASKET_REMOVE_VOLUME                2
#define ENUM_ENLIGHTRFQAVGRESPRATERANKING_LOW            1
#define ENUM_ENLIGHTRFQAVGRESPRATERANKING_MEDIUM         2
#define ENUM_ENLIGHTRFQAVGRESPRATERANKING_HIGH           3
#define ENUM_ENLIGHTRFQAVGRESPTIMERANKING_LOW            1
#define ENUM_ENLIGHTRFQAVGRESPTIMERANKING_MEDIUM         2
#define ENUM_ENLIGHTRFQAVGRESPTIMERANKING_HIGH           3
#define ENUM_EUREXVOLUMERANKING_LOW                      1
#define ENUM_EUREXVOLUMERANKING_MEDIUM                   2
#define ENUM_EUREXVOLUMERANKING_HIGH                     3
...
#define ENUM_EVENTTYPE_END_OF_RESTATEMENT                114
...
#define ENUM_HEDGINGINSTRUCTION_ON_CLOSE                 1
...
#define ENUM_MSGTYPE_PARTYDETAILSLISTREQUEST             "CF "
#define ENUM_MSGTYPE_PARTYDETAILSLISTREPORT              "CG "
...
#define ENUM_OFFERPXISLOCKED_NO                          0
#define ENUM_OFFERPXISLOCKED_YES                         1
...
#define ENUM_ORDERQTYISLOCKED_NO                         0
#define ENUM_ORDERQTYISLOCKED_YES                        1
...
#define ENUM_PARTYDETAILSTATUS_REJECTED                  2
#define ENUM_PARTYDETAILSTATUSINFORMATION_TRR_THRESHOLD_TOO_BIG 1
#define ENUM_PARTYDETAILSTATUSINFORMATION_BLOCK_ALL_ANONYMOUS 2
...
#define ENUM_PARTYORDERORIGINATIONDISCLOSUREINSTRUCTION_NO 0
#define ENUM_PARTYORDERORIGINATIONDISCLOSUREINSTRUCTION_YES 1
#define LEN_PARTYORDERORIGINATIONTRADER                  132
...
#define ENUM_QUOTECANCELREASON_EXPIRED                   5
#define ENUM_QUOTECANCELTYPE_CANCEL_ALL_QUOTES           4
#define LEN_QUOTECONDITION                               1
#define ENUM_QUOTECONDITION_ACTIVE                       "A"
#define ENUM_QUOTECONDITION_CLOSED                       "B"
#define ENUM_QUOTECONDITION_SUSPENDED                    "z"
#define ENUM_QUOTECONDITION_EXPIRED                      "8"
...
#define ENUM_QUOTESUBTYPE_BASISTRADE                     2
#define ENUM_QUOTESUBTYPE_REGULAR                        3
#define ENUM_QUOTESUBTYPE_NEGOTIATEUNDERLYINGOUTSIDEEXCHANGE 4
#define ENUM_QUOTESUBTYPE_VOLASTRATEGYFIX                5
#define ENUM_QUOTESUBTYPE_VOLASTRATEGYNEGOTIATEUNDERLYING 6
...
#define ENUM_QUOTETYPE_PWT_WITHIN_SPECIAL_AUCTION        104
...
#define ENUM_RESPONDENTTYPE_ALLMARKETPARTICIPANTS        1
...
#define ENUM_RESPONDENTTYPE_ANONYMOUS                    102
#define ENUM_REVERSALCANCELLATIONREASON_TAS_CHANGE       1
#define ENUM_REVERSALCANCELLATIONREASON_INTRADAY_EXPIRATION 2
#define ENUM_REVERSALCANCELLATIONREASON_INSTRUMENT_DELETION 3
#define ENUM_REVERSALCANCELLATIONREASON_INSTRUMENT_SUSPENSION 4
#define ENUM_REVERSALINDICATOR_NO                        0
#define ENUM_REVERSALINDICATOR_YES                       1
#define LEN_REVERSALREASONTEXT                           132
...
#define ENUM_SESSIONREJECTREASON_ORDER_NOT_ACCEPTED_IN_VOLATILITY_FREEZE 10012
...
#define ENUM_SHOWLASTDEALONCLOSURE_NO                    0
#define ENUM_SHOWLASTDEALONCLOSURE_YES                   1
#define ENUM_SIDE_BUY                                    1
#define ENUM_SIDE_SELL                                   2
#define LEN_SIDECOMPLIANCETEXT                           20
#define ENUM_SIDEDISCLOSUREINSTRUCTION_NO                0
#define ENUM_SIDEDISCLOSUREINSTRUCTION_YES               1
#define ENUM_SIDEISLOCKED_NO                             0
#define ENUM_SIDEISLOCKED_YES                            1
...
#define ENUM_SWAPCLEARER_ECAG                            0
#define ENUM_SWAPCLEARER_NON_ECAG                        1
...
#define ENUM_TRADEAGGREGATIONTRANSTYPE_NEW               0
...
#define ENUM_TRADEALLOCSTATUS_PENDING_EXECUTION          6
#define ENUM_TRADEALLOCSTATUS_PENDING_REVERSAL           7
#define ENUM_TRADEALLOCSTATUS_APPROVED_REVERSAL          8
#define ENUM_TRADEALLOCSTATUS_REVERSED                   9
#define ENUM_TRADEALLOCSTATUS_CANCELLED_REVERSAL         10
...
#define ENUM_TRADETOQUOTERATIORANKING_LOW                1
#define ENUM_TRADETOQUOTERATIORANKING_MEDIUM             2
#define ENUM_TRADETOQUOTERATIORANKING_HIGH               3
...
#define ENUM_TRDRPTSTATUS_PENDING_CANCEL                 5
...
#define ENUM_TRDTYPE_COMPRESSION                         50
...
#define ENUM_TRDTYPE_BLOCK_QTPIP                         1007
#define ENUM_TRDTYPE_BTRF                                1010
#define ENUM_TRDTYPE_EBB                                 1011
#define ENUM_TRIGGERED_NOT_TRIGGERED                     0
#define ENUM_TRIGGERED_TRIGGERED_STOP                    1
#define ENUM_TRIGGERED_TRIGGERED_OCO                     2
