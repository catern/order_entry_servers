...
#define	TID_RFQ_SPECIALIST_BROADCAST                     10419		// < RFQSpecialistBroadcast (QRS Request For Quote Notification)
...
#define MAX_SPECIALIST_DELETE_ALL_ORDER_BROADCAST_NOT_AFFECTED_ORDERS_GRP	500
...
#define ENUM_ALLOC_METHOD_NO_VALUE                       ((uint8_t) 0xff)
...
#define ENUM_CLEARING_INSTRUCTION_NO_VALUE               ((uint8_t) 0xff)
...
#define ENUM_DELIVERY_TYPE_NO_VALUE                      ((uint8_t) 0xff)
...
#define ENUM_EVENT_TYPE_END_OF_RESTATEMENT               114
...
#define ENUM_EXEC_RESTATEMENT_REASON_CHANGE_OF_SPECIALIST 119
...
#define ENUM_LAST_COUPON_DEVIATION_INDICATOR_NO_VALUE    ((uint8_t) 0xff)
...
#define ENUM_MATCH_SUB_TYPE_TRADE_AT_CLOSE               5
...
#define ENUM_QUOTE_ENTRY_REJECT_REASON_INDICATIVE_QUOTE_NOT_ALLOWED_IN_CURRENT_STATE 165
...
#define ENUM_QUOTE_REQUEST_REJECT_REASON_NO_VALUE        ((uint8_t) 0xff)
...
#define ENUM_QUOTE_TYPE_PWT_WITHIN_SPECIAL_AUCTION       104
...
#define ENUM_RFQ_PUBLISH_INDICATOR_NO_VALUE              ((uint8_t) 0xff)
...
#define ENUM_RFQ_REQUESTER_DISCLOSURE_INSTRUCTION_NO_VALUE ((uint8_t) 0xff)
...
#define ENUM_REFINANCING_ELIGIBILITY_INDICATOR_NO_VALUE  ((uint8_t) 0xff)
...
#define ENUM_ROOT_PARTY_CONTRA_SETTLEMENT_LOCATION_NO_VALUE 0
...
#define ENUM_ROOT_PARTY_SETTLEMENT_LOCATION_NO_VALUE     0
...
#define ENUM_SESSION_REJECT_REASON_ORDER_NOT_ACCEPTED_IN_VOLATILITY_FREEZE 10012
...
#define ENUM_STOP_PX_INDICATOR_NO_VALUE                  ((uint8_t) 0xff)
...
// DataType TradeAtCloseOptIn
#define ENUM_TRADE_AT_CLOSE_OPT_IN_NO                    0
#define ENUM_TRADE_AT_CLOSE_OPT_IN_YES                   1
#define ENUM_TRADE_AT_CLOSE_OPT_IN_NO_VALUE              ((uint8_t) 0xff)
...
// TemplateID:  10419
// Alias:       QRS Request For Quote Notification
// FIX MsgType: QuoteRequest = "R"
typedef struct
{
    MessageHeaderOutCompT MessageHeaderOut;
...
typedef struct
{
    ...
    NotAffectedOrdersGrpSeqT NotAffectedOrdersGrp[MAX_SPECIALIST_DELETE_ALL_ORDER_BROADCAST_NOT_AFFECTED_ORDERS_GRP];
...
#define	TID_RFQSPECIALISTBROADCAST                       10419		// < RFQSpecialistBroadcast (QRS Request For Quote Notification)
#define	TID_REJECT                                       10010		// < Reject (Reject)
...
#define MAX_SPECIALISTDELETEALLORDERBROADCAST_NOTAFFECTEDORDERSGRP	500
...
#define ENUM_TRADEATCLOSEOPTIN_NO                        0
#define ENUM_TRADEATCLOSEOPTIN_YES                       1
